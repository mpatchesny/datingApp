        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            if (dbContext.Users.Count() == 0)
            {
                List<User> users = new List<User>{
                    ...
                    new User(Guid.NewGuid(), "222222222", "test2@test.com", "Kasia", new DateOnly(1999,1,1), Sex.Female, null, new UserSettings(Guid.NewGuid(), Sex.Male, 18, 30, 100, 0.0, 0.0)),
                    ...
                    new User(Guid.NewGuid(), "555867530", "pam@dundermifflin.com", "Pam", new DateOnly(1979, 3, 25), Sex.Female, null, new UserSettings(Guid.NewGuid(), Sex.Male, 18, 50, 100, 0.0, 0.0), "Receptionist", "I'm Pam, I love art and design and I'm engaged to Jim. I'm not looking for anyone!"),
            ...
            {
                var photo = new Photo(Guid.NewGuid(), Guid.Parse("00000000-0000-0000-0000-000000000001"), "abc", "abc", 0);
            ...
            {
                var match = new Match(Guid.NewGuid(), Guid.Parse("00000000-0000-0000-0000-000000000001"), Guid.Parse("00000000-0000-0000-0000-000000000002"), false, false, null, DateTime.UtcNow);
