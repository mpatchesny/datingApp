...
public class ChangePhotoOridinalHandlerTests
{
    ...
    {
        var command = new ChangePhotoOridinal(Guid.Parse("00000000-0000-0000-0000-000000000001"), 1, 2);
    ...
    {
        var command = new ChangePhotoOridinal(Guid.Parse("00000000-0000-0000-0000-000000000001"), 2, 1);
        var exception = await Record.ExceptionAsync(async () => await _handler.HandleAsync(command));
    ...
    public ChangePhotoOridinalHandlerTests()
    {
        ...
        var photo = new Photo(0, Guid.Parse("00000000-0000-0000-0000-000000000001"), "abc", 0);
