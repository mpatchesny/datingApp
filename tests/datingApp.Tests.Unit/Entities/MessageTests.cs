...
public class MessageTests
{
    ...
    {
        var exception = Record.Exception(() =>new Message(Guid.NewGuid(), Guid.NewGuid(), message, false, DateTime.UtcNow));
    ...
    {
        var message = new Message(Guid.NewGuid(), Guid.NewGuid(), "test", false, DateTime.UtcNow);
