...
public sealed class SignUpHandler : ICommandHandler<SignUp>
{
    ...
    public async Task HandleAsync(SignUp command)
    {
        ...
        var user = new User(command.UserId, command.Phone, command.Email, command.Name, dateOfBirth, (UserSex) command.Sex, settings, DateTime.UtcNow, job: command.Job, bio: command.Bio);
