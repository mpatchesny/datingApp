...
public class MatchTests
{
    ...
    {
        var match = new Match(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), DateTime.UtcNow, DateTime.UtcNow, isDisplayedByUser1: isDisplayedByUser1, isDisplayedByUser2: isDisplayedByUser2);
    ...
    {
        var match = new Match(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), DateTime.UtcNow, DateTime.UtcNow, isDisplayedByUser1: true, isDisplayedByUser2: true);

        Assert.False(match.IsDisplayedByUser(Guid.NewGuid()));
    }

    [Fact]
    public void given_message_not_in_Match_AddMessage_adds_message_and_updates_LastActivityTime()
    {
        var match = new Match(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), DateTime.UtcNow, DateTime.UtcNow);
    ...
    public void given_message_in_Match_Messages_RemoveMessage_removes_message()
    {
        ...
        var match = new Match(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), DateTime.UtcNow, DateTime.UtcNow, messages: messages);
    ...
    public void given_message_not_in_Match_Messages_SetPreviousMessagesAsDisplayed_do_nothing()
    {
        ...
        var match = new Match(matchId, userId, Guid.NewGuid(), DateTime.UtcNow, DateTime.UtcNow, messages: messages);
    ...
    public void SetPreviousMessagesAsDisplayed_sets_last_message_as_displayed()
    {
        ...
        var match = new Match(matchId, userId1, userId2, DateTime.UtcNow, DateTime.UtcNow, messages: messages);
