...
public class UserTests
{
    ...
    {
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), phone, "email@email.com", "janusz", new System.DateOnly(1999,1,1), Sex.Male, null, properUserSettings));
    ...
    {
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), "012345678", badEmail, "janusz", new System.DateOnly(1999,1,1), Sex.Male, null, properUserSettings));
        Assert.NotNull(exception);
    ...
    {
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), "012345678", email, "janusz", new System.DateOnly(1999,1,1), Sex.Male, null, properUserSettings));
        Assert.NotNull(exception);
        Assert.IsType<InvalidEmailException>(exception);
    }
    ...
    {
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), "012345678", "test@test.com", username, new System.DateOnly(1999,1,1), Sex.Male, null, properUserSettings));
        Assert.NotNull(exception);
    ...
    public void user_age_below_18_or_above_100_should_throw_InvalidDateOfBirthException(DateTime date)
    {
        ...
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", invalidDob, Sex.Male, null, properUserSettings));
        Assert.NotNull(exception);
    ...
    {
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", new DateOnly(), Sex.Male, null, properUserSettings));
        Assert.NotNull(exception);
    ...
    public void user_bio_longer_than_400_chars_should_throw_BioTooLongException()
    {
        ...
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", new DateOnly(1999,1,1), Sex.Male, null, properUserSettings, "", bio));
        Assert.NotNull(exception);
    ...
    public void user_job_longer_than_50_chars_should_throw_JobTooLongException()
    {
        ...
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", new DateOnly(1999,1,1), Sex.Male, null, properUserSettings, job));
        Assert.NotNull(exception);
    ...
    public void user_get_age_returns_proper_age()
    {
        ...
        var user = new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", dob, Sex.Male, null, properUserSettings);
    ...
    {
        var exception = Record.Exception(() =>new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", new DateOnly(1999,1,1), (Sex) sex, null, properUserSettings));
        Assert.NotNull(exception);
    ...
    {
        var user = new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", new DateOnly(1999,1,1), Sex.Male, null, properUserSettings);
    ...
    {
        var user = new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", new DateOnly(1999,1,1), Sex.Male, null, properUserSettings, "", "bio");
    ...
    {
        var user = new User(Guid.NewGuid(), "012345678", "test@test.com", "janusz", new DateOnly(1999,1,1), Sex.Male, null, properUserSettings, "job");
    ...
    public UserTests()
    {
        properUserSettings = new UserSettings(Guid.NewGuid(), Sex.Female, 18, 20, 20, 45.5, 45.5);
    }
}